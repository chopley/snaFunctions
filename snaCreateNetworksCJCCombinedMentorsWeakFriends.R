...
for(nEgo in egoNetworkVector) 
{
  ...
  tt2$tieStrength[tt2$tieStrength == 3] <- 2
  ...
  #The mapping above was changed as follows:
  #  E(g2)$width[tt2$friends==1]=1 ##associate
  #  E(g2)$width[tt2$friends==2]=3 ##weak friend/mentor
  #  E(g2)$width[tt2$friends==3]=9 ##strong friend
  #  E(g2)$color<-"black"  
...
#  E(g2)$color<-"black"
 ## and these use colouts 
  ...
  E(g2)$color[E(g2)$Strength==2]="red" ##weak friend/mentor
#  E(g2)$color[E(g2)$Strength==3]="green" ##mentor
  E(g2)$color[E(g2)$Strength==3]="black" ##strong friend
